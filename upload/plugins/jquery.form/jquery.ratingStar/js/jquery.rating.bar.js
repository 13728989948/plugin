(function (a) {
    a.fn.webwidget_rating_bar = function (p) {
        ...
        function init() {
            ...
            for (var i = 1; i <= b; i++) {
                a.append('<li style="background-image:url(' + d + '/jquery.ratingStar_g_001.gif)"><div></div></li>')
            }
            a.insertAfter(q);
            q.next("ul").children("li").children("div").css('background-image', 'url(' + d + '/jquery.ratingStar_g_001.gif)');
