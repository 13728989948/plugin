            ...
            if (options.slideshow == 1) {
                ...
                if (options.navigation == 1) { //Skip if no navigation
                    ...
                    $('#nextslide img').hover(function () {
                        ...
                        $(this).attr("src", "images/jquery.image.026_g_004.gif");
                    }, function () {
                        if ($.paused == true) return false;
                        $(this).attr("src", "images/jquery.image.026_g_005.gif");
                    });
                    $('#prevslide img').hover(function () {
                        if ($.paused == true) return false;
                        $(this).attr("src", "images/jquery.image.026_g_001.gif");
                    }, function () {
                        if ($.paused == true) return false;
                        $(this).attr("src", "images/jquery.image.026_g_002.gif");
                    });

                    //Play/Pause Button
                    $('#pauseplay').click(function () {
                        if ($.inAnimation) return false;
                        var src = ($(this).find('img').attr("src") === "images/jquery.image.026_g_010.gif") ? "images/jquery.image.026_g_008.gif" : "images/jquery.image.026_g_010.gif";
                        if (src == "images/jquery.image.026_g_008.gif") {
                            $(this).find('img').attr("src", "images/jquery.image.026_g_010.gif");
                            $.paused = false;
                            slideshow_interval = setInterval(nextslide, options.slide_interval);
                        } else {
                            $(this).find('img').attr("src", "images/jquery.image.026_g_008.gif");
                            clearInterval(slideshow_interval);
                            $.paused = true;
                        }
                    ...
                    $('#pauseplay').mouseover(function () {
                        var imagecheck = ($(this).find('img').attr("src") === "images/jquery.image.026_g_011.gif");
                        if (imagecheck) {
                            $(this).find('img').attr("src", "images/jquery.image.026_g_010.gif");
                        } else {
                            $(this).find('img').attr("src", "images/jquery.image.026_g_008.gif");
                    ...
                    $('#pauseplay').mouseout(function () {
                        var imagecheck = ($(this).find('img').attr("src") === "images/jquery.image.026_g_010.gif");
                        if (imagecheck) {
                            $(this).find('img').attr("src", "images/jquery.image.026_g_011.gif");
                        } else {
                            $(this).find('img').attr("src", "images/jquery.image.026_g_009.gif");
                        }
                        return false;
                    });
                }
        ...
        $('#supersize > *').hover(function () {
            if (options.slideshow == 1 && options.pause_hover == 1) {
                if (!($.paused) && options.navigation == 1) {
                    $('#pauseplay > img').attr("src", "images/jquery.image.026_g_008.gif");
                    clearInterval(slideshow_interval);
                }
            }
            ...
            if (options.slideshow == 1 && options.pause_hover == 1) {
                if (!($.paused) && options.navigation == 1) {
                    $('#pauseplay > img').attr("src", "images/jquery.image.026_g_009.gif");
                    slideshow_interval = setInterval(nextslide, options.slide_interval);
                }
            }
