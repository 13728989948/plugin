;(function (e) {
    e.fn.mogFocus = function (t) {
        ...
        return this.each(function () {
            function _() {
                r.next("ul").find("img").each(function (t) {
                    var n = e(this).attr("src"), r = e(this).attr("height"), i = e(this).attr("width"),
                        s = n.substring(n.lastIndexOf(".") + 1, n.length), o = parseInt(e(this).css("marginLeft"));
            ...
            function P() {
                p.animate({marginLeft: -u, opacity: .8}, n.prevNextAnima), d.animate({
                    marginRight: -u,
                    opacity: .8
                }, n.prevNextAnima)
            }
            ...
            function H() {
                p.animate({
                    ...
                    opacity: 0
                }, n.prevNextAnima), d.animate({marginRight: -(u + n.prevNextPos), opacity: 0}, n.prevNextAnima)
            }
            ...
            function F(t) {
                ...
                var i = {
                    fade: function () {
                        ...
                        var e = Math.floor(Math.random() * c.length), i = r.children().height(),
                            s = r.children().width(), o = [function () {
                                j({top: -i}, {top: 0})
                            }, function () {
                                j({left: s}, {left: 0})
                            }, function () {
            ...
            function q() {
                h.hide(), t.css({top: Math.round(s / 2), height: 0, display: "block"}).delay(700).animate({
                    top: 0,
                    height: s
                }, {
                    duration: 1e3, easing: "easeInOutQuart", complete: function () {
            ...
            function R() {
                t.css("display", "block"), n.prevNextToggle == "show" && (p.css({
                    marginLeft: -u,
                    opacity: .8
                }), d.css({marginRight: -u, opacity: .8}))
            }

            var t = e(this), r = t.children().children().first(), i = r.children().length, s = t.height(),
                o = r.find("img").attr("width"), u = Math.round(o / 2), a = 0, f = null, l = [],
                c = ["top", "right", "bottom", "left", "fadeTop", "fadeRight", "fadeBottom", "fadeLeft"];
            ...
            if (n.animationWay == "fade" || n.animationWay == "randomImg") r.parent().children("ul").children().css({position: "absolute"}), r.children().filter(":not(':first')").hide().parent().next("ul").children().filter(":not(':first')").hide();
            ...
            p.css({marginLeft: -(u + n.prevNextPos), opacity: 0}), d.css({
            ...
            if (n.animationWay == "tbSliding") {
                ...
                D(r, y), D(v, b), v.children().css({height: m - g, paddingTop: g}).parent().css({
                    top: "auto",
                    bottom: 0
                }), r.css("bottom", 0)
            }
            if (n.btnStyle == "thumbnail") {
                ...
                if (h.children().length > n.thumlen) {
                    ...
                    var w = h.children(), E = parseInt(w.css("marginRight")), S = w.outerWidth() + E,
                        x = e(".thumPrev"), T = e(".thumNext"), N = Math.ceil(n.thumlen / 2),
                        C = Math.ceil(w.length / N), k = 0, L = 0;
                    h.parent().css("width", S * n.thumlen + (x.width() + parseInt(x.css("marginRight"))) * 2), h.wrap("<div class='btnWarp'></div>"), t.find(".btnWarp").css({
                        "float": "left",
                        position: "relative",
                        width: S * n.thumlen,
                        ...
                        width: S * w.length,
                        height: w.outerHeight()
                    }), x.css("visibility", "hidden"), x.css("float", "left").click(function () {
        ...
        prevNextPos: 70,
        prevNextAnima: {duration: 600, easing: "easeInOutBack"},
        prevNextToggle: "show",
        btnStyle: "thumbnail",
        thumWidth: 90,
        thumHeight: 36,
        thumlen: 5,
        thumCSS: {right: "50%", "margin-right": -390},
        thumSubsty: {border: "1px solid #ccc", padding: 1, background: "#fff"},
        thumSelected: {border: "1px solid #6d6d6d", background: "#fff"},
        single: !0,
        focusDelay: 0,
        focusDelayTwo: 200,
        focusTime: {duration: 1300, easing: "easeInOutQuart"},
        focusTwoTime: {duration: 1300, easing: "easeInOutQuart"},
        fadeTime: 400,
        fadeTwoTime: 600,
        randomsImgTime: 600,
