            ...
            if (options.slideshow == 1){
                ...
                if (options.navigation == 1){ //Skip if no navigation
                    ...
                    $('#nextslide').mousedown(function() {
                        $(this).attr("src", "images/jquery.supersized_p_004.png");
                    });
                    $('#nextslide').mouseup(function() {
                        $(this).attr("src", "images/jquery.supersized_p_005.png");
                    });
                    ...
                    $('#prevslide').mousedown(function() {
                        $(this).attr("src", "images/jquery.supersized_p_001.png");
                    });
                    $('#prevslide').mouseup(function() {
                        $(this).attr("src", "images/jquery.supersized_p_002.png");
                    });
                    ...
                    $('#pauseplay').click(function() {
                        if($.inAnimation) return false;
                        var src = ($(this).attr("src") === "images/jquery.supersized_p_009.png") ? "images/jquery.supersized_p_007.png" : "images/jquery.supersized_p_009.png";
                        if (src == "images/jquery.supersized_p_007.png"){
                            $(this).attr("src", "images/jquery.supersized_p_009.png");
                            $.paused = false;
                            slideshow_interval = setInterval(nextslide, options.slide_interval);
                        }else{
                            $(this).attr("src", "images/jquery.supersized_p_007.png");
                            clearInterval(slideshow_interval);
                            $.paused = true;
                        }
                        $(this).attr("src", src);
                    ...
                    $('#pauseplay').mouseover(function() {
                        var imagecheck = ($(this).attr("src") === "images/jquery.supersized_p_010.png");
                        if (imagecheck){
                            $(this).attr("src", "images/jquery.supersized_p_009.png");
                        }else{
                            $(this).attr("src", "images/jquery.supersized_p_007.png");
                    ...
                    $('#pauseplay').mouseout(function() {
                        var imagecheck = ($(this).attr("src") === "images/jquery.supersized_p_009.png");
                        if (imagecheck){
                            $(this).attr("src", "images/jquery.supersized_p_010.png");
                        }else{
                            $(this).attr("src", "images/jquery.supersized_p_008.png");
                        }
                        return false;
                    });
                }
        ...
        $('#supersized').hover(function() {
            if (options.slideshow == 1 && options.pause_hover == 1){
                if(!($.paused) && options.navigation == 1){
                    $('#pauseplay').attr("src", "images/jquery.supersized_p_007.png");
                    clearInterval(slideshow_interval);
                }
            }
            ...
            if (options.slideshow == 1 && options.pause_hover == 1){
                if(!($.paused) && options.navigation == 1){
                    $('#pauseplay').attr("src", "images/jquery.supersized_p_008.png");
                    slideshow_interval = setInterval(nextslide, options.slide_interval);
                }
            }
