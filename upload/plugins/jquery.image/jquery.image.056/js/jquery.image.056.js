(function (a) {
    a.fn.webwidget_tip_imagesAdSense = function (p) {
        ...
        switch (b) {
            case'notepaper':
                tip_button_image = d + "/jquery.image.056_p_008.png";
                tip_button_image_over = d + "/jquery.image.056_p_007.png";
                break;
            case'exclamation':
                tip_button_image = d + "/jquery.image.056_p_004.png";
                tip_button_image_over = d + "/jquery.image.056_p_003.png";
                break;
            case'circle':
                tip_button_image = d + "/jquery.image.056_p_002.png";
                tip_button_image_over = d + "/jquery.image.056_p_001.png";
                break;
            case'interrogation':
                tip_button_image = d + "/jquery.image.056_p_006.png";
                tip_button_image_over = d + "/jquery.image.056_p_005.png";
                break;
            default:
                break
        }
        ...
        all_box.children(".button_box").children("img").hover(
            function () {
                ...
                if (tip_position == 'left') {
                    all_box.children(".show").css({
                        top: (parseInt(position_data[index].y) + 20) + "px",
                        left: (parseInt(position_data[index].x) - e) + "px"
                    });
                } else {
                    all_box.children(".show").css({
                        top: (parseInt(position_data[index].y) + 20) + "px",
                        left: (parseInt(position_data[index].x) + 30) + "px"
                    });
                }
