            ...
            $mouseTrap.bind('mouseenter', this, function (event) {
                ...
                if (sImg.attr('title') && opts.showTitle) {
                    zoomDiv.append(format(
                        '<div class="cloud-zoom-title">%0</div>', sImg
                            .attr('title'))).find(':last').css(
                        'opacity', opts.titleOpacity)
                }
                ...
                if (opts.tint) {
                    ...
                    $tint = jWin
                        .append(format(
                            ...
                            sImg.outerWidth(), sImg.outerHeight(),
                            opts.tint)).find(':last');
                ...
                if (opts.softFocus) {
                    ...
                    softFocus = jWin
                        .append(format(
                            ...
                            sImg.outerWidth() - 2, sImg.outerHeight()
                            - 2, opts.tint)).find(':last');
        ...
        this.each(function () {
            ...
            if ($(this).is('.cloud-zoom')) {
                ...
                if ($(this).parent().attr('id') != 'wrap') {
                    $(this)
                        .wrap('<div id="wrap" style="top:0px;z-index:9999;position:relative;"></div>')
                }
