...
$(function () {
    ...
    $thumb_imgs.each(function () {
        ...
        $('<img/>').load(function () {
            ...
            if (loaded == nmb_thumbs * 2)
                start();
        }).attr('src', $this.attr('src').replace('thumb_', ''));
    });
    ...
    $thumbs.bind('click', function () {
        ...
        if (mode == 'grid') {
            ...
            var image_src = $this.find('img').attr('src').replace('thumb_', '');
            $thumbs.each(function (i) {
                var $thumb = $(this);
    ...
    $im_next.bind('click', function () {
        ...
        if ($next_thumb.length > 0) {
            var image_src = $next_thumb.find('img').attr('src').replace('thumb_', '');
    ...
    $im_prev.bind('click', function () {
        ...
        if ($prev_thumb.length > 0) {
            var image_src = $prev_thumb.find('img').attr('src').replace('thumb_', '');
            var arr = Array.shuffle(positionsArray.slice(0));
            $thumbs.each(function (i) {
                var t = $(this);
                setTimeout(function () {
