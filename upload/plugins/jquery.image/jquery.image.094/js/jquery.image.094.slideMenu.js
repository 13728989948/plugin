...
var slideMenu = function (options) {
    ...
    function out_left(id, to) {
        ...
        if (v.count > 0) {
            jQuery(o.div + " ul:eq(" + id + ") li").each(function (index) {
                ...
                jQuery(this).delay((index + 1) * o.delay).animate({left: "-=" + v.x}, o.speed, function () {
                    in_right(to, last);
                });
            });
        }
    ...
    function out_right(id, to) {
        ...
        if (v.count > 0) {
            jQuery(o.div + " ul:eq(" + id + ") li").each(function (index) {
                ...
                var last = (index + 1 == v.count) ? true : false;
                jQuery(this).delay((v.count - index) * o.delay).animate({left: "+=" + v.x}, o.speed, function () {
                    in_left(to, last);
                });
            });
        }
    ...
    window.onresize = function () {
        v.middle = jQuery(document).width() / 2, v.c_o = jQuery(o.div).offset();
    };
