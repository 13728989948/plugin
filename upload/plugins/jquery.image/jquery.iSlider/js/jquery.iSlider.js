/**
 * iSlider A simple, efficent mobile slider
 *
 * @Author qbatyqi
 *
 * @param {Object}
 *            opts 参数集
 * @param {Element}
 *            opts.dom 外层元素 Outer wrapper
 * @param {Object}
 *            opts.data 数据列表 Content data Please refer to README 请参考README
 * @class
 */
 ...
 *            <li>容器 Img wrapper
 * @param {String}
 *            axis 动画方向 animate direction
 * @param {Number}
 *            scale 容器宽度 Outer wrapper
 * @param {Number}
 *            i
 *            <li>容器index Img wrapper's index
 * @param {Number}
