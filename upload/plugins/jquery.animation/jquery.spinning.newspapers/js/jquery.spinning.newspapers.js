$(window).load(function () {
    ...
    $.when(
        loadImage(imgPath + "jquery.spinning.newspapers_p_005.png"),
        loadImage(imgPath + "jquery.spinning.newspapers_p_003.png"),
        loadImage(imgPath + "jquery.spinning.newspapers_p_002.png"),
        loadImage(imgPath + "jquery.spinning.newspapers_p_004.png"),
        loadImage(imgPath + "jquery.spinning.newspapers_p_001.png")
