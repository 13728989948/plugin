...
// particle variables
    particles = [], MAX_PARTICLES = 60, particleImage = new Image();

particleImage.src = 'images/jquery.animation.015_p_004.png';
...
function makeParticle(particleCount) {
    ...
    for (var i = 0; i < particleCount; i++) {
        ...
        // var particle = new ImageParticle(particleImage, HALF_WIDTH,
        // HALF_HEIGHT*0.75);
