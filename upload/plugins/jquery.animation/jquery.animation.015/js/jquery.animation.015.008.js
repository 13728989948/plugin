...
// mouse variables
    mouseX = HALF_WIDTH, mouseY = HALF_HEIGHT, mouseVelX = 0, mouseVelY = 0, lastMouseX = mouseX, lastMouseY = mouseY,
    mouseDown = false,

    canvas = document.createElement('canvas'), context = canvas.getContext('2d'),

// particle variables
    particles = [], MAX_PARTICLES = 200, particleImage = new Image();

particleImage.src = 'images/jquery.animation.015_p_003.png';
