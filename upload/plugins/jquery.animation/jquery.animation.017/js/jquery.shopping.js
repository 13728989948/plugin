                ...
                addShoping: function (e) {
                    ...
                    if (dis) {
                        if ($('#floatOrder').length <= 0) {
                            $('body').append('<div id="floatOrder"><img src="images/jquery.animation.017_s_001.svg" width="50" height="50" /></div');
                        }
                        ;
                        var $obj = $('#floatOrder');
                        if (!$obj.is(':animated')) {
                                ...
                                $obj.stop(false, false).animate({'top': Y - 20, 'opacity': 0}, 500, function () {
                                    $obj.fadeOut(300, function () {
                                        ...
                                        var l = $('.J-shoping-list').length,
                                            num = Number($num.text());
                                        if (l < 5) {
                                            $body.prepend('<div class="J-shoping-list" data-id="' + id + '"><a href="#"title=""><img src="images/jquery.animation.017_s_001.svg" width="50"height="50"/></a><div class="J-shoping-list-a"><p>彩涂板卷(镀铝锌基板)</p><p><span class="left">TDC51D+AZ</span><span class="right"><em>150.000</em>吨</span></p></div><div class="baseBg J-shoping-close"></div></div>');
                                        }
                                        ;
                                        $num.text(num + 1);
                                    });
